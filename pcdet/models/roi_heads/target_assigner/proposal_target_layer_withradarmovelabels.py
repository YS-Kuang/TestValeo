...
class ProposalTargetLayer(nn.Module):
    ...
    def forward(self, batch_dict):
        ...
        Returns:
            batch_dict:
                ...
                rcnn_cls_labels: (B, M)
        """
        batch_rois, batch_gt_of_rois, batch_roi_ious, batch_roi_scores, batch_roi_labels, batch_roi_features, batch_roi_radar_features, batch_roi_movelabels = self.sample_rois_for_rcnn(
        ...
        targets_dict = {'rois': batch_rois, 'gt_of_rois': batch_gt_of_rois, 'gt_iou_of_rois': batch_roi_ious,
                        ...
                        'reg_valid_mask': reg_valid_mask, 'rcnn_cls_labels': batch_cls_labels, 'rcnn_move_labels': batch_roi_movelabels}
    ...
    def sample_rois_for_rcnn(self, batch_dict):
        ...
        roi_movelabels = batch_dict['gt_move_labels']
        ...
        batch_roi_movelabels = rois.new_zeros(batch_size, self.roi_sampler_cfg.ROI_PER_IMAGE)
        
        for index in range(batch_size):
            cur_roi, cur_gt, cur_roi_labels, cur_roi_scores, cur_roi_features, cur_roi_radar_features, cur_roi_movelabels = \
                rois[index], gt_boxes[index], roi_labels[index], roi_scores[index], roi_features[index], roi_radar_features[index], roi_movelabels[index]
            k = cur_gt.__len__() - 1
            ...
            batch_roi_movelabels[index] = cur_roi_movelabels[gt_assignment[sampled_inds]]

        return batch_rois, batch_gt_of_rois, batch_roi_ious, batch_roi_scores, batch_roi_labels, batch_roi_features, batch_roi_radar_features, batch_roi_movelabels
